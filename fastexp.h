...
// Inspired by https://quadst.rip/ln-approx
...
namespace fastmath
{
    ...
    struct FastExp
    {
        static Real evaluate(Real x)
        {
            ...
            const Real scaled = x * Info<Real>::log2e;
            const Real int_part = std::floor(scaled);
            const Real frac_part = scaled - int_part;

            Real poly_val = PolynomialFit<Real, degree, 0>::evaluate(frac_part) + 1.0;

            unsigned_t k = std::bit_cast<unsigned_t>(poly_val);
            k += shift * static_cast<unsigned_t>(int_part);

            return std::bit_cast<Real>(k);
        }
    };
    ...
    template <typename Real>
    constexpr Real Data<Real, 1>::coefficients[2];
    ...
    template <typename Real>
    constexpr Real Data<Real, 2>::coefficients[3];
    ...
    template <typename Real>
    constexpr Real Data<Real, 3>::coefficients[4];
    ...
    template <typename Real>
    constexpr Real Data<Real, 4>::coefficients[5];
    ...
    template <typename Real>
    constexpr Real Data<Real, 5>::coefficients[6];
    ...
    template <typename Real>
    constexpr Real Data<Real, 6>::coefficients[7];
    ...
    template <typename Real>
    constexpr Real Data<Real, 7>::coefficients[8];
    ...
    template <typename Real>
    constexpr Real Data<Real, 8>::coefficients[9];
    ...
    template <typename Real>
    Real constexpr Data<Real, 9>::coefficients[10];
    ...
    template <typename Real, size_t degree = 2>
    inline Real exp(const Real &x)
    {
        return FastExp<Real, degree>::evaluate(x);
    }
